...
// });
mouse.x = randomIntFromRange(-500, canvas.width + 500);
mouse.y = randomIntFromRange(-400, -500);
// -- EVENT LISTENERS
...
function init() {
  ...
  for (var i = 0; i < 50; i++) {
    ...
    stars.push(new Stars(stars_x, stars_y, stars_radius, stars_dy, stars_dx, stars_color));
  }
}
